namespace Unity.Services.Multiplayer
{
    public static partial class SessionOptionsExtensions
    {
        ...
        /// <returns>
        /// The <see cref="SessionOptions"/> configured to use <see
        /// cref="RelayProtocol.DTLS"/> on most platforms, <see
        /// cref="RelayProtocol.WSS"/> on WebGL for communication.
        /// </returns>
        /// <remarks>
        /// <para>The <a
        /// href="https://docs.unity.com/ugs/en-us/manual/relay/manual/locations-and-regions">region</a>
        ...
        {
            return WithRelayNetwork(options, new RelayNetworkOptions(RelayProtocol.Default, region, false));
        }
        ...
        /// <returns>
        /// The <see cref="SessionOptions"/> configured to use <see
        /// cref="RelayProtocol.DTLS"/> on most platforms, or <see
        /// cref="RelayProtocol.WSS"/> on WebGL for network communication.
        /// </returns>
        /// <remarks>
            ...
            where T : SessionOptions
        {
            return options.WithDistributedAuthorityNetwork(
                new RelayNetworkOptions(RelayProtocol.Default, region, false));
        }
