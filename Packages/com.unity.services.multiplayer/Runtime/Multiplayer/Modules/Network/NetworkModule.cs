            ...
            try
            {
                ...
                switch (previousMetadata.Network)
                {
                    ...
                    case NetworkType.Relay:
                        ...
                        await ResetAsync();
                        await ApplyMigrationAsync();
                        await StartRelayNetworkAsync(new RelayNetworkOptions(RelayProtocol.Default, previousMetadata.RelayRegion, !string.IsNullOrEmpty(previousMetadata.RelayRegion)));
                        break;
                }
                ...
                switch (NetworkInfo.Network)
                {
                    case NetworkType.DistributedAuthority:
                    {
                        ...
                        var networkConfiguration = new NetworkConfiguration(
                            ...
                            m_DaHandler.GetRelayServerData(NetworkInfo.RelayOptions.Protocol),
                        ...
                        m_NetworkMetadata = new NetworkMetadata
                        {
                            ...
                            RelayProtocol = NetworkInfo.RelayOptions.Protocol,
                    ...
                    case NetworkType.Relay:
                    {
                        ...
                        var relayServerData = m_RelayHandler.GetRelayServerData(NetworkInfo.RelayOptions.Protocol);
                        ...
                        var clientRelayData = m_RelayHandler.GetRelayServerData(NetworkInfo.RelayOptions.Protocol);
                ...
                switch (m_NetworkMetadata.Network)
                {
                    ...
                    case NetworkType.Relay:
                    {
                        ...
                        await m_RelayHandler.JoinAllocationAsync(
                            m_NetworkMetadata
                                .RelayJoinCode);
                        var relayServerData =
                            m_RelayHandler.GetRelayServerData(
                    ...
                    case NetworkType.DistributedAuthority:
                    {
                        ...
                        networkConfiguration = new NetworkConfiguration(
                            NetworkRole.Client,
                            NetworkType.DistributedAuthority,
                            m_DaHandler.GetRelayServerData(RelayProtocol.Default),
                            connectPayload.SerializeToNativeArray());
                        break;
                    }
                    default:
