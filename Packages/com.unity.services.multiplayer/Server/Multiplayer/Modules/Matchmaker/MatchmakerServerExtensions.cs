...
namespace Unity.Services.Multiplayer
{
    ...
    public static class MatchmakerServerExtensions
    {
        ...
        {
            var networkInfoOption = options.GetOption<NetworkInfoOption>();
            ...
            return options.WithOption(new MatchmakerInitializationOption(true,
                networkInfoOption.Options.PublishAddress.NetworkEndpoint));
        }
            ...
            int playerConnectionTimeout, int backfillingLoopInterval) where T : SessionOptions
        {
            ...
            if (networkInfoOption == null)
            {
                throw new SessionException("No network info defined on the session.", SessionError.InvalidOperation);
            }
